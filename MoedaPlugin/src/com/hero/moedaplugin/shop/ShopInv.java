...
public class ShopInv {
	...
	public static void open(Player p){
		Inventory inv = Bukkit.createInventory(null, InventoryType.PLAYER, "§6§lSHOP DE MOEDAS");
		
		ItemStack sword = Criar.add(Material.DIAMOND_SWORD, "§2§lDOLLYNHO §7§lKIT", new String[] {" ", "§7§l> §7§lKIT §2§lDOLLYNHO §4§lRARO", "§7§l> §2§lCusto: 50m"}, Enchantment.DAMAGE_ALL, 15);
		ItemStack peitoral = Criar.add(Material.DIAMOND_CHESTPLATE, "§c§lSPIDER MANO §7§lKIT", new String[] {" ", "§7§l> §1§LKIT §c§lSPIDER MANO §4§lRARO", "§7§l> §2§lCusto: 100m"}, Enchantment.DAMAGE_ALL, 15);
		ItemStack beacon = Criar.add(Material.BONE, "§5§lSEGURA ESSA OSSADA §7§lKIT", new String[] {" ", "§7§l> §7Osso §4§lOP §4§lRARO", "§7§l> §2§lCusto: 50m"}, Enchantment.KNOCKBACK, 15);
		ItemStack espada = Criar.add(Material.IRON_SWORD, "§8§lTITANIUM §7§lKIT", new String[] {" ", "§7§l> §7KIT TITANIUM §4§lRARO", "§7§l> §2§lCusto: 150m"}, Enchantment.DAMAGE_ALL, 15);
