package com.hero.moedaplugin.api;
...
public class Criar
{
  ...
  public static ItemStack add1(Material m, int durabilidade)
  {
  ...
  public static ItemStack add12(Material m, String nome, int quantidade)
  {
    ItemStack item = new ItemStack(m,quantidade);
    ItemMeta meta = item.getItemMeta();
    meta.setDisplayName(nome);
  ...
  public static ItemStack add(Material m, String nome, String[] lore, int durability, int quantidade)
  {
    ItemStack item = new ItemStack(m,quantidade);
    item.setDurability((short)durability);
    ItemMeta meta = item.getItemMeta();
  ...
  public static ItemStack add(Material m, String nome, Enchantment enchant1, int lvl1, Enchantment enchant2, int lvl2, Enchantment enchant3, int lvl3)
  {
    ItemStack item = new ItemStack(m);
    item.addUnsafeEnchantment(enchant1, lvl1);
    item.addUnsafeEnchantment(enchant2, lvl2);
  ...
  public static ItemStack add(Material m, String nome, Enchantment enchant1, int lvl1, Enchantment enchant2, int lvl2, Enchantment enchant3, int lvl3, Enchantment enchant4, int lvl4)
  {
    ItemStack item = new ItemStack(m);
    item.addUnsafeEnchantment(enchant1, lvl1);
    item.addUnsafeEnchantment(enchant2, lvl2);
  ...
  public static ItemStack add(Material m, String nome, String[] lore, Enchantment enchant1, int lvl1, Enchantment enchant2, int lvl2, Enchantment enchant3, int lvl3,  Enchantment enchant4, int lvl4)
  {
    ItemStack item = new ItemStack(m);
    item.addUnsafeEnchantment(enchant1, lvl1);
    item.addUnsafeEnchantment(enchant2, lvl2);
  ...
  public static ItemStack couro(Color cor, String nome, Enchantment enchant1, Integer lvl1, Enchantment enchant2, Integer lvl2, Enchantment enchant3, Integer lvl3)
  {
    ItemStack item = new ItemStack(Material.LEATHER_CHESTPLATE);
    item.addUnsafeEnchantment(enchant1, lvl1);
    item.addUnsafeEnchantment(enchant2, lvl2);
  ...
  public static ItemStack getSpawner(String nome, String[] lore, int amount, EntityType type)
  {
    ItemStack item = new ItemStack(Material.MOB_SPAWNER, amount);
  ...
  @SuppressWarnings("deprecation")
  public static ItemStack mod(Integer id, int durabilidade)
    {
  ...
  @SuppressWarnings("deprecation")
  public static ItemStack mod(String nome,Integer id, int durabilidade)
    {
      ItemStack item = new ItemStack(Material.getMaterial(id));
      item.setDurability((short)durabilidade);
      ItemMeta meta = item.getItemMeta();
  ...
  @SuppressWarnings("deprecation")
  public static ItemStack mod(String nome, String[] lore, Integer id, int durabilidade)
    {
      ItemStack item = new ItemStack(Material.getMaterial(id));
      item.setDurability((short)durabilidade);
      ItemMeta meta = item.getItemMeta();
  ...
  @SuppressWarnings("deprecation")
  public static ItemStack mod(String nome,Integer id, int durabilidade, Enchantment enchant1, int lvl1)
    {
      ItemStack item = new ItemStack(Material.getMaterial(id));
      item.setDurability((short)durabilidade);
      item.addUnsafeEnchantment(enchant1, lvl1);
  ...
  @SuppressWarnings("deprecation")
public static ItemStack mod(String nome,Integer id, int durabilidade, Enchantment enchant1, int lvl1, Enchantment enchant2, int lvl2)
  {
    ItemStack item = new ItemStack(Material.getMaterial(id));
    item.setDurability((short)durabilidade);
    item.addUnsafeEnchantment(enchant1, lvl1);
  ...
  @SuppressWarnings("deprecation")
public static ItemStack mod(String nome,Integer id, int durabilidade, Enchantment enchant1, int lvl1, Enchantment enchant2, int lvl2, Enchantment enchant3, int lvl3)
  {
    ItemStack item = new ItemStack(Material.getMaterial(id));
    item.setDurability((short)durabilidade);
    item.addUnsafeEnchantment(enchant1, lvl1);
  ...
  @SuppressWarnings("deprecation")
  public static ItemStack mod(String nome,Integer id, int durabilidade, Enchantment enchant1, int lvl1, Enchantment enchant2, int lvl2, Enchantment enchant3, int lvl3, Enchantment enchant4, int lvl4)
    {
      ItemStack item = new ItemStack(Material.getMaterial(id));
      item.setDurability((short)durabilidade);
      item.addUnsafeEnchantment(enchant1, lvl1);
  ...
  @SuppressWarnings("deprecation")
  public static ItemStack mod(String nome,Integer id, int durabilidade, Enchantment enchant1, int lvl1, Enchantment enchant2, int lvl2, Enchantment enchant3, int lvl3, Enchantment enchant4, int lvl4, Enchantment enchant5, int lvl5)
    {
      ItemStack item = new ItemStack(Material.getMaterial(id));
      item.setDurability((short)durabilidade);
      item.addUnsafeEnchantment(enchant1, lvl1);
  ...
  @SuppressWarnings("deprecation")
  public static ItemStack mod(String nome,Integer id, int durabilidade, Enchantment enchant1, int lvl1, Enchantment enchant2, int lvl2, Enchantment enchant3, int lvl3, Enchantment enchant4, int lvl4, Enchantment enchant5, int lvl5, Enchantment enchant6, int lvl6)
    {
      ItemStack item = new ItemStack(Material.getMaterial(id));
      item.setDurability((short)durabilidade);
      item.addUnsafeEnchantment(enchant1, lvl1);
