...
public class ShopVipInv {
	...
	public static void open(Player p){
		...
		ItemStack sword = Criar.add(Material.IRON_ORE, "§8§l[§3§lGuerreiro§8§l]", new String[] {" ", "§7§l> §e§lClique para comprar o vip Guerreiro!", "§7§l> §e40 CASH"}, Enchantment.DAMAGE_ALL, 15);
		ItemStack peitoral = Criar.add(Material.GOLD_ORE, "§8§l[§a§lEspartano§8§l]", new String[] {" ", "§7§l> §e§lClique para comprar o vip Espartano!", "§7§l> §e90 CASH"}, Enchantment.DAMAGE_ALL, 15);
		ItemStack beacon = Criar.add(Material.DIAMOND_ORE, "§8§l[§6§lLendario§8§l]", new String[] {" ", "§7§l> §e§lClique para comprar o vip Lendario!", "§7§l> §e300 CASH"}, Enchantment.KNOCKBACK, 15);
